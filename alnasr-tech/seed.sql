...
--      psql $DATABASE_URL -f /dev/stdin" < seed.sql
--
-- Or simply: psql $DATABASE_URL -f seed.sql
-- ═══════════════════════════════════════════════════════════════════════
...
-- ── 2. Admin User ──────────────────────────────────────────────────────
-- Password: Admin@123  (hashed with Argon2 — must be set via the API)
-- We insert a placeholder hash; the first login should use the register endpoint
-- or you can update the password hash via the Rust CLI.
-- For now we use a pre-computed Argon2 hash for "Admin@123":
...
('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a03', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a03', 'INV-2024-003', 'c1eebc99-9c0b-4ef8-bb6d-6bb9bd380a03', 'issued',  35000.00, 4900.00,  39900.00,  '2024-07-15T00:00:00Z', NULL, '2024-06-10T00:00:00Z', NULL, NOW(), NOW()),
...
-- ── Done ──────────────────────────────────────────────────────────────
-- After running this seed, log in with:
